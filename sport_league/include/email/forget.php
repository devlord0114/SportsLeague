                                    ...
                                    <table class="body">
                                        <tr>
                                            ...
                                            <td class="body-padded">
                                                <div class="body-title">Reset Now</div>
                                                <table class="body-text">
                                                    <tr>
                                                        <td class="body-text-cell">
                                                            Welcome everyone!
                                                            <br>
                                                            You can reset your password by clicking following button.
                                                        </td>
                                                    </tr>
                                                </table>
                                                <div>
                                                    <button href="#" class="btn btn-primary" style="display: block; width: 100%; font-size: 0.8rem; border-radius: 10rem; padding: 0.75rem 1rem; border: 1px solid transparent;">Reset Password</button>
                                                </div>
                                            </td>
                                            <td class="body-padding"></td>
                                        </tr>
