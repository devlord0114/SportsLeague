...
<html lang="en">
    <head>
        ...
        <title>Sports League - Create League</title>
    </head>
    <body id="page-top">
        <!-- Page Wrapper -->
        <div id="wrapper">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-4 text-gray-800">Create League</h1>
                        </div>
                        <!-- Content Row -->
                        <form class="create_league" method="post">
                            <div class="row shadow">
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="card-body">                                        
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="league_description" name="league_description" placeholder="Enter League Description" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Point Description</label>
                                            <input type="text" id="point_description" name="point_description" placeholder="Enter Point Description" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Rule</label>
                                            <input type="text" id="rule" name="rule" placeholder="Enter Rule" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Date</label>
                                            <input type="date" id="date" name="date" placeholder="2020-10-14" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Time</label>
                                            <input type="time" id="time" name="time" placeholder="22:00" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <!-- Project Card Example -->
                                ...
                                <div class="col-lg-12">
                                    <button type="submit" id="create" name="create" class="btn btn-primary btn-user btn-block">Create League</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <script src="js/app/league_create.js"></script>
    </body>
</html>